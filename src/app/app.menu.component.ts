    ...
    ngOnInit() {
        this.model = [
            ...
            /****************OPERACIONAL*******************/
            {
             ...
             /****************ESTOQUE/MERCADORIAS*******************/
             {
                label: 'Mercadorias/Estoque', icon: 'fa fa-fw fa-home',
                items: [
                   
                    {label: 'Unidades de medida', icon: 'fa fa-fw fa-columns', routerLink: ['/Unidade_medida']},   
                    {label: 'Fabricantes', icon: 'fa fa-fw fa-columns', routerLink: ['/Fabricante']},  
            ...
            /***********************DEMO***************************/
            {
                label: 'Demo', icon: 'fa fa-fw fa-gg',
                items: [
